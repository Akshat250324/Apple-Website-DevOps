...
urlpatterns = [
    ...
    path('contact/',views.iphoneseries,name='iphoneseries'),
    path('iphone_categories',views.iphone_categories,name='iphonecategories'),
    path('ipad_categories',views.ipad_categories,name='ipadcategories'),
    path('macbook_categories',views.macbook_categories,name='macbookcategories'),
    path('apple_details/<int:id>/',views.apple_details,name='appledetails'),
    ...
    path('password_reset_done/', views.password_reset_done, name='passwordresetdone'),
     ...
     path('apple/<int:id>/', views.apple_detail, name='apple_detail'),
]
